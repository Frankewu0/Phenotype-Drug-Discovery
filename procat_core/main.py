...
def main():
    ...
    dataFolder = "/home/jovyan/CPI/data/bindingdb/cluster/"
    print(cfg.DA.TASK)
    ...
    if not cfg.DA.TASK:
        ...
        train_path = os.path.join(dataFolder, 'train_cluster.csv')
        val_path = os.path.join(dataFolder, "val_cluster.csv")
        test_path = os.path.join(dataFolder, "test_cluster.csv")
